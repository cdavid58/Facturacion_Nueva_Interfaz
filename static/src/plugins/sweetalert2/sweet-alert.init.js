!function ($) {
    ...
    SweetAlert.prototype.init = function () {
        ...
        //Success Message
        $('#send_email_recovery').click(function () {
            swal(
                {
                    title: 'Excelente!',
                    text: 'El correo fué enviado con éxito',
                    type: 'success',
                    timer: 2000
                }
            )
        ...
        //Success Message
        $('#send_email_recovery_error').click(function () {
            swal(
                {
                    title: 'UPS algo paso!',
        ...
        $('#send_dian').click(function () {
            swal(
                {
                    title: 'Éxito!',
                    text: 'La factura se envio con exito a la DIAN',
                    type: 'success',
                    timer: 2000
                }
            )
